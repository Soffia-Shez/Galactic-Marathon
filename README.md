...
<div>
  <ul>
    <li>Interpretación de estructura y dinámica de las galaxias</li>
    <li>Expanción del universo invitando a ver la vida desde una perspectiva más extensa y menos personal, de manera didáctica.</li>
    <li>Visión espiritual de la conexión cósmica con respecto a la vida a escala universal.</li>
    <li>Manipulación de pygame para elevar la dificultad de los niveles disponibles.</li>
  </ul>
</div>
